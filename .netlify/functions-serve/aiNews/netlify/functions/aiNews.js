...
var aiNews_exports = {};
__export(aiNews_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(aiNews_exports);
...
var decodeHtml = (s = "") => s.replace(/&amp;/g, "&").replace(/&quot;/g, '"').replace(/&#39;/g, "'");
...
var normalizeItem = async (item, sourceName) => {
...
var parseFeed = async (url) => {
  ...
  let items = channel?.item || channel?.entry || (Array.isArray(json.item) ? json.item : []) || [];
...
//# sourceMappingURL=aiNews.js.map
